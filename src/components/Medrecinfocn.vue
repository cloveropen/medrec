    ...
    <v-form ref="formReg" id="printMe" lazy-validation>
      ...
      <v-card class="mx-auto" max-width="99%" min-width="100%">
        <v-card-text>
          ...
          <v-row>
            <v-col cols="12" md="4">
              <v-text-field class="abc" v-model="medrecInfo.idcard" label="身份证号" disabled></v-text-field>
            </v-col>
            <v-col cols="12" md="2">
              <v-text-field class="abc" v-model="medrecInfo.occupation" label="职业"></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-radio-group v-model="medrecInfo.maritalStatus" label="婚姻" row>
                <v-radio label="1.未婚" color="green" value="1"></v-radio>
                <v-radio label="2.已婚" color="green" value="2"></v-radio>
                <v-radio label="3.丧偶" color="green" value="3"></v-radio>
                <v-radio label="4.离婚" color="green" value="4"></v-radio>
                <v-radio label="9.其他" color="green" value="9"></v-radio>
              </v-radio-group>
            </v-col>
          </v-row>
          <v-row>
          ...
          <v-row>
            <v-col cols="12" md="6">
              <v-radio-group v-model="medrecInfo.admWay" label=" 入院途径 " row>
                <v-radio label="1.急诊" color="green" value="1"></v-radio>
                <v-radio label="2.门诊" color="green" value="2"></v-radio>
                <v-radio label="3.其他医疗机构入院" color="green" value="3"></v-radio>
                <v-radio label="9.其他" color="green" value="9"></v-radio>
              </v-radio-group>
            </v-col>
            <v-col cols="12" md="6">
              <v-radio-group v-model="medrecInfo.admWay" label="治疗类别" row>
                <v-radio label="1.中医(1.1中医 1.2民族医)" color="green" value="1"></v-radio>
                <v-radio label="2.中西医" color="green" value="2"></v-radio>
                <v-radio label="3.西医" color="green" value="3"></v-radio>
              </v-radio-group>
            </v-col>
          </v-row>
          <v-row>
          ...
          <v-row>
            <v-col cols="12" md="6">
              <v-text-field class="abc" v-model="medrecInfo.outDiagNameCn" label="门（急）诊诊断（中医诊断）"></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field class="abc" v-model="medrecInfo.outDiagIdCn" label="疾病编码"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="6">
              <v-text-field class="abc" v-model="medrecInfo.outDiagName" label="门（急）诊诊断（西医诊断）"></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field class="abc" v-model="medrecInfo.outDiagId" label="疾病编码"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="6">
               <v-radio-group v-model="medrecInfo.pathway" label="实施临床路径" row>
                <v-radio label="1.中医" color="green" value="1"></v-radio>
                <v-radio label="2.西医" color="green" value="2"></v-radio>
                <v-radio label="3.否" color="green" value="3"></v-radio>
              </v-radio-group>
            </v-col>
            <v-col cols="12" md="6">
              <v-radio-group v-model="medrecInfo.chnMedPrep" label="使用医疗机构中药制剂" row>
                <v-radio label="1.是" color="green" value="1"></v-radio>
                <v-radio label="2.否" color="green" value="2"></v-radio>
              </v-radio-group>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="4">
              <v-radio-group v-model="medrecInfo.chnEquipment" label="使用中医诊疗设备" row>
                <v-radio label="1.是" color="green" value="1"></v-radio>
                <v-radio label="2.否" color="green" value="2"></v-radio>
              </v-radio-group>
            </v-col>
            <v-col cols="12" md="4">
              <v-radio-group v-model="medrecInfo.chnTechnology" label="使用中医诊疗技术" row>
                <v-radio label="1.是" color="green" value="1"></v-radio>
                <v-radio label="2.否" color="green" value="2"></v-radio>
              </v-radio-group>
            </v-col>
            <v-col cols="12" md="4">
              <v-radio-group v-model="medrecInfo.chnInvestigate" label="辨证施护" row>
                <v-radio label="1.是" color="green" value="1"></v-radio>
                <v-radio label="2.否" color="green" value="2"></v-radio>
              </v-radio-group>
            </v-col>
          ...
          <v-row>
            <v-col cols="12" md="4">
              <v-radio-group v-model="medrecInfo.drugAlle" label="药物过敏" row>
            ...
            <v-col cols="12" md="4">
              <v-radio-group v-model="medrecInfo.autopsyDp" label="死亡患者尸检" row>
                <v-radio label="1.是" color="green" value="1"></v-radio>
                <v-radio label="2.否" color="green" value="2"></v-radio>
              </v-radio-group>
            </v-col>
          ...
          <v-row>
            <v-col cols="12" md="7">
              <v-radio-group v-model="medrecInfo.bloodType" label="血型" row>
                <v-radio label="1.A" color="green" value="1"></v-radio>
                <v-radio label="2.B" color="green" value="2"></v-radio>
                <v-radio label="3.O" color="green" value="3"></v-radio>
                <v-radio label="4.AB" color="green" value="4"></v-radio>
                <v-radio label="5.不祥" color="green" value="5"></v-radio>
                <v-radio label="6.未查" color="green" value="6"></v-radio>
              </v-radio-group>
            </v-col>
            <v-col cols="12" md="5">
              <v-radio-group v-model="medrecInfo.rh" label="Rh" row>
                <v-radio label="1.阴" color="green" value="1"></v-radio>
                <v-radio label="2.阳" color="green" value="2"></v-radio>
                <v-radio label="3.不祥" color="green" value="3"></v-radio>
                <v-radio label="4.未查" color="green" value="4"></v-radio>
              </v-radio-group>
            </v-col>
          </v-row>
          <v-row>
          ...
          <v-row>
            <v-col cols="12" md="12">
              <v-radio-group v-model="medrecInfo.disWay" label="离院方式" row>
                ...
                <v-radio label="4.非医嘱离院" color="green" value="4"></v-radio>
                <v-radio label="5.死亡" color="green" value="5"></v-radio>
                <v-radio label="6.其他" color="green" value="6"></v-radio>
              </v-radio-group>
            </v-col>
          </v-row>
          <v-row>
          ...
          <v-row>
            ...
            <v-col cols="12" md="3">
              <v-text-field class="abc" v-model="medrecCost.sdtFee" label="(中医辨证论治费"></v-text-field>
            </v-col>
            <v-col cols="12" md="3">
              <v-text-field class="abc" v-model="medrecCost.sdtcFee" label="中医辨证论治会诊费)"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="4">
          ...
          <v-row>
            ...
            <v-col cols="12" md="3">
              <v-text-field class="abc" v-model="medrecCost.tcmFee" label="（13）中医治疗"></v-text-field>
            </v-col>
            <v-col cols="12" md="3">
              <v-text-field class="abc" v-model="medrecCost.exterTreatFee" label="（中医外治"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="2">
              <v-text-field class="abc" v-model="medrecCost.boneInjuryFee" label="中医骨伤"></v-text-field>
            </v-col>
            <v-col cols="12" md="2">
              <v-text-field class="abc" v-model="medrecCost.acupMoxiFee" label="针刺与灸法"></v-text-field>
            </v-col>
            <v-col cols="12" md="2">
              <v-text-field class="abc" v-model="medrecCost.massTherFee" label="中医推拿治疗"></v-text-field>
            </v-col>
            <v-col cols="12" md="2">
              <v-text-field class="abc" v-model="medrecCost.anorTreatFee" label="中医肛肠治疗"></v-text-field>
            </v-col>
            <v-col cols="12" md="2">
              <v-text-field class="abc" v-model="medrecCost.specTreatFee" label="中医特殊治疗）"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="3">
              <v-text-field class="abc" v-model="medrecCost.cmOtherFee" label="（14）中医其他"></v-text-field>
            </v-col>
            <v-col cols="12" md="4">
              <v-text-field class="abc" v-model="medrecCost.specPrepProcFee" label="（中药特殊调配加工"></v-text-field>
            </v-col>
            <v-col cols="12" md="3">
              <v-text-field class="abc" v-model="medrecCost.diaDietFee" label="辨证施膳）"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" md="4">
